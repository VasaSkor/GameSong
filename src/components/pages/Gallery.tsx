        ...
        <div className='gallery'>
            <div className='card_container'>
                <Card card={{
                    ...
                    description: 'Genshin Impact is an open world action RPG inspired by The Legend of Zelda series.' +
                        ' Players are waiting for the fantasy world of Teyvat, which is full of ruins of ancient ' +
            ...
            <div className='card_container'>
                <Card card={{
                    ...
                    description: 'Grand Theft Auto IV follows the story of Niko Bellic; Before the events of the game,' +
